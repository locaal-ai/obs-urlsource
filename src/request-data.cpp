		...
		if (request_data->obs_text_source != "") {
			...
			if (is_obs_source_text(request_data->obs_text_source)) {
                ...
                if (request_data->obs_input_source_resize_option != "100%") {
                    ...
                    std::string scaleStr = request_data->obs_input_source_resize_option;
                    scaleStr.erase(std::remove(scaleStr.begin(), scaleStr.end(), '%'), scaleStr.end());
...
url_source_request_data unserialize_request_data(std::string serialized_request_data)
{
	...
	try {
        ...
        request_data.obs_input_source_resize_option = json.value("obs_input_source_resize_option", "100%");
