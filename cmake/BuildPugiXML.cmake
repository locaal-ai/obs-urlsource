if(OS_MACOS)
  # use pugixml from brew
  add_library(pugixml STATIC IMPORTED)
  set_target_properties(pugixml PROPERTIES IMPORTED_LOCATION /usr/local/lib/libpugixml.a)

  add_library(libpugixml INTERFACE)
  target_link_libraries(libpugixml INTERFACE pugixml)
  target_include_directories(libpugixml INTERFACE /usr/local/include)
else()
